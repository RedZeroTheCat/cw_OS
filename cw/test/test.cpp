...
{
    auto filename = "D:\\Study\\cw_os\\cw\\filesystem\\tables\\HMHUH.txt";
    auto index_filename = "D:\\Study\\cw_os\\cw\\filesystem\\tables\\index_HMHUH.txt";
...
//    }
    ...
    try
    {
        ...
        {
            tbl.insert("GOOOL" + std::to_string(i), user_data(i, "NO", "DED"));
...
//        tbl.dispose_from_filesystem("zzzzz6998");
    ...
    {
	    std::cout << "oi oi;   " << e.what() << std::endl;
    }
    try
    {
