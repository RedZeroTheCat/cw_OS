...
void data_base::execute_command_from_file(const std::string &filename)
{
    ...
    while (std::getline(in_file, command))
    {
        ...
        if (action == "insert_pool")
        {
            ...
            std::cout << "Schemas pool inserted" << std::endl;
        }
        else if (action == "insert_schema")
        {
            ...
            std::cout << "Schema inserted" << std::endl;
        }
        else if (action == "insert_table")
        {
            ...
            std::cout << "Table inserted" << std::endl;
        }
        ...
        else if (action == "obtain_data")
        {
            ...
            std::cout << "Data obtained" << std::endl;
        }
        else if (action == "obtain_between_data")
        {
            ...
            std::cout << "Data obtained between keys" << std::endl;
        }
        ...
        else if (action == "dispose_pool")
        {
            ...
            std::cout << "Schemas pool disposed" << std::endl;
        }
        else if (action == "dispose_schema")
        {
            ...
            std::cout << "Schema disposed" << std::endl;
        }
        else if (action == "dispose_table")
        {
            ...
            std::cout << "Table disposed" << std::endl;
        }
        else if (action == "dispose_data")
        {
            ...
            std::cout << "Data disposed" << std::endl;
        }
        else
        {
...
void data_base::start_console_dialog()
{
    ...
    while (true)
    {
        std::cout << "Input operation from list: \n"
                     ...
                     "[11] update_data \n"
                     "[12] execute_file_command\n"
                     "[13] save_db_state\n"
                     "[14] load_db_state\n"
                     "[15] obtain_all\n"
                     "[16] exit\n"
                     "(Please, input only text command or number)\n" << std::endl;
        ...
        getline(iss, action, ':');
        if (action == "insert_pool" || action == "1")
        {
        ...
        else if (action == "insert_schema" || action == "2")
        {
        ...
        else if (action == "insert_table" || action == "3")
        {
        ...
        else if (action == "dispose_pool" || action == "4")
        {
            std::string pool;
        ...
        else if (action == "insert_data" || action == "7")
        {
        ...
        else if (action == "obtain_all" || action == "15")
        {
        ...
        else if (action == "obtain_data" || action == "9")
        {
        ...
        else if (action == "obtain_between_data" || action == "10")
        {
        ...
        else if (action == "update_data" || action == "11")
        {
            std::string pool_name, schema_name, table_name, user_data_key, data;
            read_path_to_table_and_key(pool_name, schema_name, table_name, user_data_key);
            std::string str_id, str_name, str_surname;
        ...
        else if (action == "dispose_schema" || action == "5")
        {
            std::string pool_name, schema_name;
            std::cout << "Enter the name of the schema pool: ";
            std::cin >> pool_name;
        ...
        else if (action == "dispose_table" || action == "6")
        {
            std::string pool_name, schema_name, table_name;
            read_path_to_table(pool_name, schema_name, table_name);
        ...
        else if (action == "dispose_data" || action == "8")
        {
            std::string pool_name, schema_name, table_name, user_data_key;
            read_path_to_table_and_key(pool_name, schema_name, table_name, user_data_key);
            try
        ...
        else if (action == "save_db_state" || action == "13")
        {
            try
            {
        ...
        else if (action == "load_db_state" || action == "14")
        {
            try
            {
        ...
        else if (action == "execute_file_command" || action == "12")
        {
            std::string filename;
            ...
            {
                std::cerr << "Execution command file failed: " << e.what() << std::endl;
            }
        }
        else
        {
