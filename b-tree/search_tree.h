#ifndef MATH_PRACTICE_AND_OPERATING_SYSTEMS_TEMPLATE_REPO_SEARCH_TREE_H
#define MATH_PRACTICE_AND_OPERATING_SYSTEMS_TEMPLATE_REPO_SEARCH_TREE_H
	...
	tkey const &key)
{
    ...
    if (_root == nullptr)
    {
        result.push(std::pair<typename search_tree<tkey, tvalue>::common_node **, int>(&_root, index));
...
#endif //MATH_PRACTICE_AND_OPERATING_SYSTEMS_TEMPLATE_REPO_SEARCH_TREE_H